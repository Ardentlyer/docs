...
> 代码连接地址：mysql-master-headless.mysql.svc.cluster.local:3306
>
...
> 代码连接地址：mysql-slave1-headless.mysql.svc.cluster.local:3306
>
> 访问地址：ip（192.168.1.10） + 端口（30337）
>
> 用户密码：root、Admin@2024
...
```shell
kubectl apply -f ~/mysql-yml/mysql-slave2.yml
```

> 代码连接地址：mysql-slave2-headless.mysql.svc.cluster.local:3306
>
> 访问地址：ip（192.168.1.10） + 端口（30338）
>
> 用户密码：root、Admin@2024
...
```shell
kubectl exec -it mysql-master-0 -n mysql -- mysql -pAdmin@2024 -e "show databases;"
```

```shell
kubectl exec -it mysql-slave1-0 -n mysql -- mysql -pAdmin@2024 -e "show databases;"
```

```shell
kubectl exec -it mysql-slave2-0 -n mysql -- mysql -pAdmin@2024 -e "show databases;"
```

```shell
kubectl exec -it mysql-master-0 -n mysql -- mysql -pAdmin@2024 -e "create database openhhh;"
```
